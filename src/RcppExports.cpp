...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type styleAsAttr(styleAsAttrSEXP);
    Rcpp::traits::input_parameter< Rcpp::List >::type aliases(aliasesSEXP);
    rcpp_result_gen = Rcpp::wrap(svglite_(file, bg, width, height, pointsize, standalone,styleAsAttr, aliases));
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type styleAsAttr(styleAsAttrSEXP);
    Rcpp::traits::input_parameter< Rcpp::List >::type aliases(aliasesSEXP);
    rcpp_result_gen = Rcpp::wrap(svgstring_(env, bg, width, height, pointsize, standalone,styleAsAttr, aliases));
    return rcpp_result_gen;
END_RCPP
}
// get_svg_content
